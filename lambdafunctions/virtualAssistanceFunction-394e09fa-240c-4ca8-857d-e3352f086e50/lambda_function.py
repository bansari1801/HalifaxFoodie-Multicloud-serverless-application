...
def getNavigationLink(name):
    ...
    if name == "REGISTER USER":
        return "Here is the link to the registration page : https://serverlessprojectlatest-iy5iahomva-uc.a.run.app/registration"
    if name == "CHAT":
        return "Here is the link to chat with our representative : https://serverlessprojectlatest-iy5iahomva-uc.a.run.app/home"
    if name == "UPLOAD RECIPE":
        return "Here is the link to upload recipes : https://serverlessprojectlatest-iy5iahomva-uc.a.run.app/recipes"
    if name == "VISUALIZE":
        return "Here is the link to visualize the data : https://serverlessprojectlatest-iy5iahomva-uc.a.run.app/visualization"    
    ...
    if intentName == "OrderComplaints":
        ...
        if slots['email']:
            ...
            if authenticateUser(email,'customer'):
                ...
                intent['state'] = 'Fulfilled'
                response = getFulfillmentResponse({},intent,"Below is the link to chat with our representative. It will take 2-3 minutes: https://serverlessprojectlatest-iy5iahomva-uc.a.run.app/registration/chat")
